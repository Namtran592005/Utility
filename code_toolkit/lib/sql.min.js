!(function (e) {
      ...
      return (c.hexNumber &&
        ...
        ? c.escapeConstant &&
          ...
          ? ((t.tokenize = (function a(i) {
            ...
            t.tokenize(e, t))
          : "." == r
          ? c.zerolessFloat && e.match(/^(?:\d+(?:e[+-]?\d+)?)/i)
            ? "number"
            : e.match(/^\.+/)
            ? null
            : e.match(/^[\w\d_$#]+/)
  ...
  a.defineMIME("text/x-sql", {
    ...
    support: y("doubleQuote binaryNumber hexNumber"),
  }),
    ...
    a.defineMIME("text/x-sparksql", {
      ...
      operatorChars: /^[*\/+\-%<>!=~&|^]/,
      dateSQL: y("date time timestamp"),
      support: y("doubleQuote zerolessFloat"),
    }),
    ...
    a.defineMIME("text/x-trino", {
      ...
      support: y("decimallessFloat zerolessFloat hexNumber"),
    });
});
