  ...
  (() => {
            ...
            return (
              ...
              (R.prototype.process = function (E) {
                for (
                  ...
                  var N = T[S];
                  if (N.isComplete) {
                    if ((N.finish(), N.data !== O.fail)) {
                      for (var I = N.wantedBy, L = I.length; L--; ) {
                        var C = I[L];
                        this.complete(C, N);
                      }
                ...
                if ("string" == typeof R) {
                  ...
                  return (
                    ...
                    (T += A.map(function (E, T) {
                      return I(this.line - A.length + T + 1, N) + " " + E;
                    }, this).join("\n")) +
                      "\n" +
                      I("", N + O) +
                      "^\n"
              ...
              (O.prototype.feed = function (E) {
                ...
                for (A.reset(E, this.lexerState); ; ) {
                  ...
                  (O = new R(this.grammar, I)), this.table.push(O);
                  for (
                    var L,
    ...
    return (
      (() => {
        ...
        const T = (E) => E.flatMap(S),
          S = (E) => D(N(E)).map(O),
          O = (E) => E.replace(/ +/g, " ").trim(),
          N = (E) => ({ type: "mandatory_block", items: I(E, 0)[0] }),
          I = (E, T, R) => {
            const A = [];
            for (; E[T]; ) {
              const [S, O] = L(E, T);
          ...
          D = (E) => {
            ...
            if ("concatenation" === E.type)
              return E.items.map(D).reduce(P, [""]);
            if ("mandatory_block" === E.type) return E.items.flatMap(D);
            if ("optional_block" === E.type) return ["", ...E.items.flatMap(D)];
        ...
        const M = (E) => ({
          ...
          U = M(1 / 0),
          t = (E) => (T) => T.type === E.type && T.text === E.text,
          r = {
            ARRAY: t({ text: "ARRAY", type: s.RESERVED_DATA_TYPE }),
            BY: t({ text: "BY", type: s.RESERVED_KEYWORD }),
            SET: t({ text: "SET", type: s.RESERVED_CLAUSE }),
            STRUCT: t({ text: "STRUCT", type: s.RESERVED_DATA_TYPE }),
            WINDOW: t({ text: "WINDOW", type: s.RESERVED_CLAUSE }),
            VALUES: t({ text: "VALUES", type: s.RESERVED_CLAUSE }),
          },
          G = (E) =>
            E === s.RESERVED_DATA_TYPE ||
            E === s.RESERVED_KEYWORD ||
            E === s.RESERVED_FUNCTION_NAME ||
            E === s.RESERVED_PHRASE ||
            E === s.RESERVED_CLAUSE ||
            E === s.RESERVED_SELECT ||
            E === s.RESERVED_SET_OPERATION ||
            E === s.RESERVED_JOIN ||
            E === s.ARRAY_KEYWORD ||
            E === s.CASE ||
            E === s.END ||
            ...
            E === s.OR ||
            E === s.XOR,
          n = T(["SELECT [ALL | DISTINCT] [AS STRUCT | AS VALUE]"]),
          i = T([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
          ...
          F = {
                ...
                return (function (E) {
                  ...
                  (function (E) {
                    ...
                    for (let A = 0; A < E.length; A++) {
                      const S = E[A];
                      if (
                        (r.ARRAY(S) || r.STRUCT(S)) &&
                        "<" ===
                          (null === (T = E[A + 1]) || void 0 === T
                            ? void 0
                            : T.text)
                      ) {
                        const T = V(E, A + 1),
                        ...
                        R.push({
                          type: s.IDENTIFIER,
                          raw: O.map(Y("raw")).join(""),
                          text: O.map(Y("text")).join(""),
                          start: S.start,
                        }),
                          (A = T);
                      } else R.push(S);
            ...
            formatOptions: { onelineClauses: a },
          },
          Y = (E) => (T) =>
            T.type === s.IDENTIFIER || T.type === s.COMMA ? T[E] + " " : T[E];
        function V(E, T) {
          let R = 0;
        ...
        const l = T(["SELECT [ALL | DISTINCT]"]),
          ...
          X = T(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
          c = T([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          u = {
            ...
            formatOptions: { onelineClauses: W },
          },
          h = T(["SELECT [ALL | DISTINCT]"]),
          d = T([
            "WITH [RECURSIVE]",
            "INTO",
            "FROM",
          ...
          y = T(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
          f = T([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
          ...
          x = {
            ...
            formatOptions: { onelineClauses: K },
          },
          J = T(["SELECT [ALL | DISTINCT]"]),
          $ = T([
            "WITH",
            "FROM",
            "WHERE",
          ...
          Q = T(["{ROWS | RANGE} BETWEEN"]),
          Z = {
            name: "hive",
            tokenizerOptions: {
              reservedSelect: J,
              reservedClauses: [...$, ...g],
              reservedSetOperations: w,
              reservedJoins: v,
              reservedPhrases: Q,
              reservedKeywords: [
                "ADD",
            ...
            formatOptions: { onelineClauses: g },
          };
        function q(E) {
          return E.map((T, R) => {
            const A = E[R + 1] || U;
        ...
        const k = T(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
          j = T([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
          ...
          SE = T(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
          OE = T([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
          ...
          _E = {
            ...
            formatOptions: { onelineClauses: NE },
          },
          eE = T(["SELECT [ALL | DISTINCT]"]),
          DE = T([
            "WITH",
            "FROM",
            "WHERE",
          ...
          sE = T(["UNION [ALL]", "EXCEPT [ALL]", "INTERSECT [ALL]"]),
          ME = T(["JOIN", "{LEFT | RIGHT} [OUTER] JOIN", "INNER JOIN"]),
          UE = T(["{ROWS | RANGE | GROUPS} BETWEEN"]),
          tE = {
            name: "n1ql",
            tokenizerOptions: {
              reservedSelect: eE,
              reservedClauses: [...DE, ...PE],
            ...
            formatOptions: { onelineClauses: PE },
          },
          rE = T(["SELECT [ALL | DISTINCT | UNIQUE]"]),
          GE = T([
            "WITH",
            "FROM",
            "WHERE",
          ...
          iE = T(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
          aE = T([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          HE = {
            ...
            formatOptions: { alwaysDenseOperators: ["@"], onelineClauses: nE },
          },
          BE = T(["SELECT [ALL | DISTINCT]"]),
          FE = T([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
          ...
          uE = T(["UNION [ALL]", "EXCEPT", "INTERSECT", "MINUS"]),
          hE = T([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          KE = {
            ...
            formatOptions: { alwaysDenseOperators: ["::"], onelineClauses: mE },
          },
          yE = T(["SELECT [ALL | DISTINCT]"]),
          fE = T([
            "WITH",
            "FROM",
            "WHERE",
          ...
          gE = {
            ...
            tokenizerOptions: {
              ...
              postProcess: function (E) {
                return E.map((T, R) => {
                  const A = E[R - 1] || U,
                    S = E[R + 1] || U;
                  return r.WINDOW(T) && S.type === s.OPEN_PAREN
                    ? Object.assign(Object.assign({}, T), {
                        type: s.RESERVED_FUNCTION_NAME,
                      })
                    : "ITEMS" !== T.text ||
                      T.type !== s.RESERVED_KEYWORD ||
            ...
            formatOptions: { onelineClauses: bE },
          },
          wE = T(["SELECT [ALL | DISTINCT]"]),
          vE = T([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
          ...
          ZE = T(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
          qE = T([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          OT = {
            ...
            formatOptions: { onelineClauses: TT },
          },
          NT = T(["SELECT [ALL | DISTINCT]"]),
          IT = T([
            "WITH [RECURSIVE]",
            "FROM",
            "WHERE",
          ...
          eT = T(["{ROWS | RANGE | GROUPS} BETWEEN", "IS [NOT] DISTINCT FROM"]),
          DT = {
            name: "trino",
            tokenizerOptions: {
              reservedSelect: NT,
              reservedClauses: [...IT, ...LT],
            ...
            formatOptions: { onelineClauses: LT },
          },
          PT = T(["SELECT [ALL | DISTINCT]"]),
          sT = T([
            "WITH",
            "INTO",
            "FROM",
          ...
          UT = T(["UNION [ALL]", "EXCEPT", "INTERSECT"]),
          tT = T([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          GT = {
            ...
            formatOptions: { alwaysDenseOperators: ["::"], onelineClauses: MT },
          },
          nT = T(["SELECT [ALL | DISTINCT | DISTINCTROW]"]),
          iT = T([
            "WITH",
            "FROM",
            "WHERE",
          ...
          oT = T(["UNION [ALL | DISTINCT]", "EXCEPT", "INTERSECT", "MINUS"]),
          HT = T([
            "JOIN",
            "{LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{INNER | CROSS} JOIN",
          ...
          pT = T(["UNION [ALL]", "MINUS", "EXCEPT", "INTERSECT"]),
          WT = T([
            "[INNER] JOIN",
            "[NATURAL] {LEFT | RIGHT | FULL} [OUTER] JOIN",
            "{CROSS | NATURAL} JOIN",
          ...
          xT = (E, T = []) => {
            const R = "open" === E ? 0 : 1,
              A = ["()", ...T].map((E) => E[R]);
            return fT(A.map(KT).join("|"));
          },
          JT = (E, T = {}) => {
            if (0 === E.length) return /^\b$/u;
            const R = (({ rest: E, dashes: T }) =>
                E || T ? `(?![${E || ""}${T ? "-" : ""}])` : "")(T),
              A = uT(E).map(KT).join("|").replace(/ /gu, "\\s+");
            return new RegExp(`(?:${A})${R}\\b`, "iuy");
          },
          $T = (E, T) => {
            if (!E.length) return;
            const R = E.map(KT).join("|");
            return fT(`(?:${R})(?:${T})`);
          },
          gT = {
            "``": "(?:`[^`]*`)+",
            ...
            "q''": (() => {
              const E = { "<": ">", "[": "]", "(": ")", "{": "}" },
                T = Object.entries(E).map(([E, T]) =>
                  "{left}(?:(?!{right}').)*?{right}"
                    .replace(/{left}/g, KT(E))
                    .replace(/{right}/g, KT(T))
                ),
                R = KT(Object.keys(E).join(""));
        ...
        class jT {
          ...
          createParseError() {
            const E = this.input.slice(this.index, this.index + 10),
              { line: T, col: R } = kT(this.input, this.index);
            return new Error(
          ...
          getWhitespace() {
            yT.lastIndex = this.index;
            const E = yT.exec(this.input);
        ...
        class RR {
          ...
          exec(E) {
            let T,
              R = "",
              A = 0;
            if (!(T = this.matchSection(zT, E))) return null;
            for (R += T, A++; A > 0; )
              if ((T = this.matchSection(zT, E))) (R += T), A++;
              else if ((T = this.matchSection(TR, E))) (R += T), A--;
              else {
        ...
        class AR {
          ...
          tokenize(E, T) {
            const R = [
              ...
              A = new jT(R, this.dialectName).tokenize(E);
            ...
            return this.validRules([
              {
                ...
                regex: E.nestedBlockComments ? new RR() : /(\/\*[^]*?\*\/)/uy,
              },
              {
                type: s.LINE_COMMENT,
                regex:
              ...
              { type: s.QUOTED_IDENTIFIER, regex: QT(E.identTypes) },
              {
                type: s.NUMBER,
                regex:
              ...
              { type: s.CASE, regex: /CASE\b/iuy, text: SR },
              { type: s.END, regex: /END\b/iuy, text: SR },
              { type: s.BETWEEN, regex: /BETWEEN\b/iuy, text: SR },
              {
                type: s.LIMIT,
              ...
              },
              {
                ...
                regex: JT(E.reservedClauses, E.identChars),
                text: SR,
              },
              {
                type: s.RESERVED_SELECT,
                regex: JT(E.reservedSelect, E.identChars),
                text: SR,
              },
              {
                type: s.RESERVED_SET_OPERATION,
                regex: JT(E.reservedSetOperations, E.identChars),
                text: SR,
              },
              { type: s.WHEN, regex: /WHEN\b/iuy, text: SR },
              { type: s.ELSE, regex: /ELSE\b/iuy, text: SR },
              { type: s.THEN, regex: /THEN\b/iuy, text: SR },
              {
                type: s.RESERVED_JOIN,
                regex: JT(E.reservedJoins, E.identChars),
                text: SR,
              },
              { type: s.AND, regex: /AND\b/iuy, text: SR },
              { type: s.OR, regex: /OR\b/iuy, text: SR },
              {
                type: s.XOR,
              ...
              {
                type: s.RESERVED_FUNCTION_NAME,
                regex: JT(E.reservedFunctionNames, E.identChars),
                text: SR,
              },
              {
                type: s.RESERVED_DATA_TYPE,
                regex: JT(E.reservedDataTypes, E.identChars),
                text: SR,
              },
              {
                type: s.RESERVED_KEYWORD,
                regex: JT(E.reservedKeywords, E.identChars),
                text: SR,
              },
            ]);
          }
            ...
            return this.validRules([
              {
                ...
                regex: E.variableTypes
                  ? ((A = E.variableTypes),
                    fT(
                      A.map((E) => ("regex" in E ? E.regex : wT(E))).join("|")
                    ))
                  : void 0,
              },
              { type: s.STRING, regex: QT(E.stringTypes) },
              { type: s.IDENTIFIER, regex: ZT(E.identChars) },
              { type: s.DELIMITER, regex: /[;]/uy },
              { type: s.COMMA, regex: /[,]/y },
              { type: s.OPEN_PAREN, regex: xT("open", E.extraParens) },
              { type: s.CLOSE_PAREN, regex: xT("close", E.extraParens) },
              {
                type: s.OPERATOR,
                regex:
                  ((R = [
            ...
            return this.validRules([
              {
                ...
                regex: $T(I.named, qT(E.paramChars || E.identChars)),
                key: (E) => E.slice(1),
              },
              {
                type: s.QUOTED_PARAMETER,
                regex: $T(I.quoted, vT(E.identTypes)),
                key: (E) =>
                  (({ tokenKey: E, quoteChar: T }) =>
                    E.replace(new RegExp(KT("\\" + T), "gu"), T))({
        ...
        const DR = (E, T, R) => {
          ...
          sR = (E, T, R) => {
            if (E.type === s.RESERVED_DATA_TYPE) {
              ...
              if (A && GR(A))
                return Object.assign(Object.assign({}, E), {
                  type: s.RESERVED_PARAMETERIZED_DATA_TYPE,
                });
            }
            return E;
          },
          ...
          rR = (E, T, R = 1) => {
            let A = 1;
            for (; E[T + A * R] && iR(E[T + A * R]); ) A++;
            return E[T + A * R];
          },
          GR = (E) => E.type === s.OPEN_PAREN && "(" === E.text,
          nR = (E) => E.type === s.OPEN_PAREN && "[" === E.text,
          iR = (E) => E.type === s.BLOCK_COMMENT || E.type === s.LINE_COMMENT;
        class aR {
          constructor(E) {
            (this.tokenize = E),
              (this.index = 0),
          ...
          save() {}
          formatError(E) {
            const { line: T, col: R } = kT(this.input, E.start);
        ...
        !(function (E) {
          (E.statement = "statement"),
            ...
            (E.parameterized_data_type = "parameterized_data_type"),
        ...
        const BR = new aR((E) => []),
          ...
          VR = (E) => ({ type: oR.data_type, text: E.text, raw: E.raw }),
          lR = (E, { leading: T, trailing: R }) => (
          ...
          WR = {
            ...
            ParserRules: [
              ...
              },
              {
                ...
                symbols: [
                  BR.has("DELIMITER") ? { type: "DELIMITER" } : DELIMITER,
                ],
              },
              {
                name: "statement$subexpression$1",
                symbols: [BR.has("EOF") ? { type: "EOF" } : EOF],
              },
              {
                name: "statement",
                symbols: [
              ...
              },
              {
                ...
                postprocess: ([E, T, R, A]) => {
                  if (A) {
                    const [S, O] = A;
                    return {
                      type: oR.limit_clause,
                      limitKw: lR(YR(E), { trailing: T }),
                      offset: R,
                      count: O,
                    };
                  }
              ...
              },
              {
                ...
                symbols: [BR.has("ASTERISK") ? { type: "ASTERISK" } : ASTERISK],
                postprocess: () => ({ type: oR.all_columns_asterisk }),
              },
              ...
              },
              {
                ...
                postprocess: ([E, T]) => lR(E, { trailing: T }),
              },
              {
                name: "_expression_with_comments",
                symbols: ["_", "expression"],
                postprocess: ([E, T]) => lR(T, { leading: E }),
              },
              {
              ...
              },
              {
                ...
                postprocess: ([E, T, R]) => ({
                  type: oR.array_subscript,
                  array: lR(
                    { type: oR.identifier, quoted: !1, text: E.text },
                    { trailing: T }
                  ),
                  parenthesis: R,
                }),
              ...
              },
              {
                ...
                postprocess: ([E, T, R]) => ({
                  type: oR.function_call,
                  nameKw: lR(YR(E), { trailing: T }),
                  parenthesis: R,
                }),
              },
              {
              ...
              },
              {
                ...
                symbols: [
                  "atomic_expression",
                  "_",
                  BR.has("DOT") ? { type: "DOT" } : DOT,
                  "_",
                  "property_access$subexpression$1",
                ],
                postprocess: ([E, T, R, A, [S]]) => ({
                  type: oR.property_access,
                  object: lR(E, { trailing: T }),
                  property: lR(S, { leading: A }),
                }),
              },
              {
                name: "between_predicate",
                symbols: [
                  BR.has("BETWEEN") ? { type: "BETWEEN" } : BETWEEN,
                  "_",
                  "andless_expression_chain",
                  "_",
                  BR.has("AND") ? { type: "AND" } : AND,
                  "_",
                  "andless_expression",
                ],
                postprocess: ([E, T, R, A, S, O, N]) => ({
                  type: oR.between_predicate,
                  betweenKw: YR(E),
                  expr1: pR(R, { leading: T, trailing: A }),
                  andKw: YR(S),
                  expr2: [lR(N, { leading: O })],
                }),
              },
              {
              ...
              },
              {
                ...
                symbols: [
                  BR.has("CASE") ? { type: "CASE" } : CASE,
                  "_",
                  "case_expression$ebnf$1",
                  "case_expression$ebnf$2",
                  BR.has("END") ? { type: "END" } : END,
                ],
                postprocess: ([E, T, R, A, S]) => ({
                  type: oR.case_expression,
                  caseKw: lR(YR(E), { trailing: T }),
                  endKw: YR(S),
                  expr: R || [],
                  clauses: A,
                }),
              },
              {
                name: "case_clause",
                symbols: [
                  BR.has("WHEN") ? { type: "WHEN" } : WHEN,
                  "_",
                  "expression_chain_",
                  BR.has("THEN") ? { type: "THEN" } : THEN,
                  "_",
                  "expression_chain_",
                ],
                postprocess: ([E, T, R, A, S, O]) => ({
                  type: oR.case_when,
                  whenKw: lR(YR(E), { trailing: T }),
                  thenKw: lR(YR(A), { trailing: S }),
                  condition: R,
                  result: O,
                }),
              },
              {
                name: "case_clause",
                symbols: [
                  BR.has("ELSE") ? { type: "ELSE" } : ELSE,
                  "_",
                  "expression_chain_",
                ],
                postprocess: ([E, T, R]) => ({
                  type: oR.case_else,
                  elseKw: lR(YR(E), { trailing: T }),
                  result: R,
                }),
              },
              {
                name: "comma$subexpression$1",
                symbols: [BR.has("COMMA") ? { type: "COMMA" } : COMMA],
              },
              {
                name: "comma",
                symbols: ["comma$subexpression$1"],
                postprocess: ([[E]]) => ({ type: oR.comma }),
              },
              {
              ...
              },
              {
                ...
                postprocess: ([[E]]) => ({ type: oR.operator, text: E.text }),
              },
              {
                name: "operator$subexpression$1",
                symbols: [BR.has("OPERATOR") ? { type: "OPERATOR" } : OPERATOR],
              },
              {
                name: "operator",
              ...
              },
              {
                ...
                symbols: [
                  BR.has("IDENTIFIER") ? { type: "IDENTIFIER" } : IDENTIFIER,
                ],
              },
              {
                name: "identifier$subexpression$1",
                symbols: [
                  BR.has("QUOTED_IDENTIFIER")
              ...
              {
                name: "identifier$subexpression$1",
                symbols: [BR.has("VARIABLE") ? { type: "VARIABLE" } : VARIABLE],
              },
              {
                name: "identifier",
              ...
              },
              {
                ...
                symbols: [BR.has("NUMBER") ? { type: "NUMBER" } : NUMBER],
              },
              {
                name: "literal$subexpression$1",
                symbols: [BR.has("STRING") ? { type: "STRING" } : STRING],
              },
              {
                name: "literal",
                symbols: ["literal$subexpression$1"],
                postprocess: ([[E]]) => ({ type: oR.literal, text: E.text }),
              },
              {
                name: "keyword$subexpression$1",
                symbols: [
                  BR.has("RESERVED_KEYWORD")
              ...
              },
              {
                name: "data_type",
                symbols: [
                  BR.has("RESERVED_PARAMETERIZED_DATA_TYPE")
                ...
                postprocess: ([E, T, R]) => ({
                  type: oR.parameterized_data_type,
                  dataType: lR(VR(E), { trailing: T }),
                  parenthesis: R,
                }),
              },
              {
                name: "logic_operator$subexpression$1",
                symbols: [BR.has("AND") ? { type: "AND" } : AND],
              },
              {
                name: "logic_operator$subexpression$1",
                symbols: [BR.has("OR") ? { type: "OR" } : OR],
              },
              {
                name: "logic_operator$subexpression$1",
                symbols: [BR.has("XOR") ? { type: "XOR" } : XOR],
              },
              {
                name: "logic_operator",
              ...
              },
              {
                ...
                symbols: [BR.has("WHEN") ? { type: "WHEN" } : WHEN],
              },
              {
                name: "other_keyword$subexpression$1",
                symbols: [BR.has("THEN") ? { type: "THEN" } : THEN],
              },
              {
                name: "other_keyword$subexpression$1",
                symbols: [BR.has("ELSE") ? { type: "ELSE" } : ELSE],
              },
              {
                name: "other_keyword$subexpression$1",
                symbols: [BR.has("END") ? { type: "END" } : END],
              },
              {
                name: "other_keyword",
              ...
              },
              {
                name: "comment",
                symbols: [
                  BR.has("BLOCK_COMMENT")
                    ? { type: "BLOCK_COMMENT" }
                    : BLOCK_COMMENT,
                ],
                postprocess: ([E]) => ({
                  type: oR.block_comment,
                  text: E.text,
                  precedingWhitespace: E.precedingWhitespace,
                }),
              },
        ...
        class hR {
            ...
            for (const T of E)
              switch (T) {
                ...
                case uR.NO_NEWLINE:
                  ...
                  break;
                case uR.NEWLINE:
                  this.trimHorizontalWhitespace(), this.addNewline(uR.NEWLINE);
                  break;
                case uR.MANDATORY_NEWLINE:
                  this.trimHorizontalWhitespace(),
                    this.addNewline(uR.MANDATORY_NEWLINE);
                  break;
                case uR.INDENT:
                  this.addIndentation();
                  break;
                case uR.SINGLE_INDENT:
                  this.items.push(uR.SINGLE_INDENT);
                  break;
                default:
                  this.items.push(T);
              }
          ...
          trimHorizontalWhitespace() {
            for (; dR(mT(this.items)); ) this.items.pop();
          }
          trimWhitespace() {
            for (; KR(mT(this.items)); ) this.items.pop();
          }
          addNewline(E) {
            if (this.items.length > 0)
              switch (mT(this.items)) {
                case uR.NEWLINE:
        ...
        const dR = (E) => E === uR.SPACE || E === uR.SINGLE_INDENT,
          KR = (E) =>
            E === uR.SPACE || E === uR.SINGLE_INDENT || E === uR.NEWLINE;
        function yR(E, T) {
        ...
        class xR {
          ...
          decreaseTopLevel() {
            this.indentTypes.length > 0 &&
              mT(this.indentTypes) === bR &&
              this.indentTypes.pop();
          }
          decreaseBlockLevel() {
            for (
              ;
              this.indentTypes.length > 0 && this.indentTypes.pop() === bR;
        ...
        class JR extends hR {
          ...
          addToLength(E) {
            if ("string" == typeof E)
              ...
              if (E === uR.MANDATORY_NEWLINE || E === uR.NEWLINE)
                throw new $R();
              E === uR.INDENT || E === uR.SINGLE_INDENT || E === uR.SPACE
                ? this.trailingSpace ||
                  (this.length++, (this.trailingSpace = !0))
                : (E !== uR.NO_NEWLINE && E !== uR.NO_SPACE) ||
                  (this.trailingSpace &&
        ...
        class gR {
          ...
          formatNodeWithoutComments(E) {
            switch (E.type) {
              ...
              case oR.set_operation:
                return this.formatSetOperation(E);
              case oR.limit_clause:
                return this.formatLimitClause(E);
              case oR.all_columns_asterisk:
              ...
              case oR.line_comment:
                return this.formatLineComment(E);
              case oR.block_comment:
          ...
          formatParenthesis(E) {
            ...
            T
              ? (this.layout.add(E.openParen),
                ...
                this.layout.add(uR.NO_SPACE, E.closeParen, uR.SPACE))
              : (this.layout.add(E.openParen, uR.NEWLINE),
                LR(this.cfg)
                  ? (this.layout.add(uR.INDENT),
                    (this.layout = this.formatSubExpression(E.children)))
                  : (this.layout.indentation.increaseBlockLevel(),
                    this.layout.add(uR.INDENT),
                    (this.layout = this.formatSubExpression(E.children)),
                    this.layout.indentation.decreaseBlockLevel()),
                this.layout.add(uR.NEWLINE, uR.INDENT, E.closeParen, uR.SPACE));
          }
          formatBetweenPredicate(E) {
            this.layout.add(this.showKw(E.betweenKw), uR.SPACE),
          ...
          formatCaseExpression(E) {
            this.formatNode(E.caseKw),
              ...
              this.layout.indentation.decreaseBlockLevel(),
              this.layout.add(uR.NEWLINE, uR.INDENT),
          ...
          formatLimitClause(E) {
            this.withComments(E.limitKw, () => {
              this.layout.add(uR.NEWLINE, uR.INDENT, this.showKw(E.limitKw));
            }),
              this.layout.indentation.increaseTopLevel(),
              LR(this.cfg)
                ? this.layout.add(uR.SPACE)
              ...
              E.offset
                ? ((this.layout = this.formatSubExpression(E.offset)),
                  this.layout.add(uR.NO_SPACE, ",", uR.SPACE),
          ...
          formatLiteral(E) {
            this.layout.add(E.text, uR.SPACE);
          }
          formatIdentifier(E) {
            this.layout.add(this.showIdentifier(E), uR.SPACE);
          }
          formatParameter(E) {
            this.layout.add(this.params.get(E), uR.SPACE);
          }
          formatOperator({ text: E }) {
            this.cfg.denseOperators ||
            this.dialectCfg.alwaysDenseOperators.includes(E)
              ? this.layout.add(uR.NO_SPACE, E)
              : ":" === E
              ? this.layout.add(uR.NO_SPACE, E, uR.SPACE)
              : this.layout.add(E, uR.SPACE);
          }
          formatComma(E) {
            this.inline
              ? this.layout.add(uR.NO_SPACE, ",", uR.SPACE)
              : this.layout.add(uR.NO_SPACE, ",", uR.NEWLINE, uR.INDENT);
          }
          withComments(E, T) {
            this.formatComments(E.leadingComments),
              T(),
          ...
          formatComments(E) {
            E &&
              E.forEach((E) => {
                E.type === oR.line_comment
                  ? this.formatLineComment(E)
                  : this.formatBlockComment(E);
              });
          }
          formatLineComment(E) {
            dT(E.precedingWhitespace || "")
              ? this.layout.add(
                  uR.NEWLINE,
                  uR.INDENT,
                  E.text,
                  uR.MANDATORY_NEWLINE,
                  uR.INDENT
                )
              ...
              : this.layout.add(E.text, uR.MANDATORY_NEWLINE, uR.INDENT);
          }
          formatBlockComment(E) {
            this.isMultilineBlockComment(E)
              ? (this.splitBlockComment(E.text).forEach((E) => {
                  this.layout.add(uR.NEWLINE, uR.INDENT, E);
                }),
                this.layout.add(uR.NEWLINE, uR.INDENT))
              : this.layout.add(E.text, uR.SPACE);
          }
          isMultilineBlockComment(E) {
            return dT(E.text) || dT(E.precedingWhitespace || "");
          }
          isDocComment(E) {
            const T = E.split(/\n/);
            return (
          ...
          formatInlineExpression(E) {
            ...
            try {
              return new gR({
                ...
                dialectCfg: this.dialectCfg,
                params: this.params,
                layout: new JR(this.cfg.expressionWidth),
                inline: !0,
              }).format(E);
            } catch (E) {
              if (E instanceof $R)
          ...
          formatKeyword(E) {
            this.layout.add(this.showKw(E), uR.SPACE);
          }
          formatLogicalOperator(E) {
            "before" === this.cfg.logicalOperatorNewline
              ...
              : this.layout.add(this.showKw(E), uR.NEWLINE, uR.INDENT);
          }
          formatDataType(E) {
            this.layout.add(this.showDataType(E), uR.SPACE);
          }
          showKw(E) {
            return fR(E.tokenType)
              ? yR(this.showNonTabularKw(E), this.cfg.indentStyle)
          ...
          showFunctionKw(E) {
            return fR(E.tokenType)
              ? yR(this.showNonTabularFunctionKw(E), this.cfg.indentStyle)
        ...
        class wR {
          constructor(E, T) {
            (this.dialect = E),
              (this.cfg = T),
              (this.params = new CR(this.cfg.params));
          }
          format(E) {
          ...
          parse(E) {
            return (function (E) {
              ...
              const R = new aR((R) => {
                  return [
                    ...((A = E.tokenize(R, T)),
                    A.map(DR).map(PR).map(sR).map(MR).map(UR)),
                    M(R.length),
                  ];
                  var A;
                }),
                A = new cR(mR.fromCompiled(XR), { lexer: R });
              return {
                parse: (E, R) => {
                  T = R;
        ...
        const QR = {
          ...
          kR = (T, R = {}) => {
            if ("string" == typeof R.language && !ZR.includes(R.language))
              throw new vR(`Unsupported SQL dialect: ${R.language}`);
            const A = QR[R.language || "sql"];
            return jR(
              T,
              Object.assign(Object.assign({}, R), { dialect: E[A] })
            );
          },
          jR = (E, T) => {
            var { dialect: R } = T,
            ...
            const S = (function (E) {
              ...
              for (const R of T)
                if (R in E) throw new vR(`${R} config is no more supported.`);
            ...
            })(Object.assign(Object.assign({}, qR), A));
            return new wR(
              ((E) => {
                let T = NR.get(E);
                return (
                  T ||
                    ((T = {
                      tokenizer: new AR((R = E).tokenizerOptions, R.name),
                      formatOptions: IR(R.formatOptions),
                    }),
                    NR.set(E, T)),
                  T
                );
