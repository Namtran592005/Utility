    ...
    var n = [
        ...
        function (t, e, i) {
            ...
            (T.prototype.handle_whitespace_and_comments = function (t, e) {
              ...
              if (t.comments_before)
                for (var u = t.comments_before.next(); u; )
                  this.handle_whitespace_and_comments(u, e),
                    this.handle_token(u, e),
                    (u = t.comments_before.next());
              if (n)
          ...
          (T.prototype.allow_wrap_or_preserved_newline = function (t, e) {
            ...
            (T.prototype.handle_operator = function (t) {
              ...
              else if (l(t.text, ["-", "+"]) && this.start_of_object_property())
                this.print_token(t);
              else {
                if (
                  (this._flags.last_token.type === p.OPERATOR &&
            ...
            (T.prototype.print_block_commment = function (t, e) {
              ...
              if (
                ...
                for (
                  ...
                  n
                    ? (this.print_token_line_indentation(t),
                      this._output.add_token(_[i].replace(/^\s+/g, "")))
                    : u && _[i]
                    ? (this.print_token_line_indentation(t),
                      this._output.add_token(_[i].substring(a)))
                    : (this._output.current_line.set_indent(-1),
                      this._output.add_token(_[i])),
                    this.print_newline(!1, e);
            ...
            (e.prototype.ensure_empty_line_above = function (t, e) {
              for (var i = this.__lines.length - 2; 0 <= i; ) {
                ...
                if (0 !== n.item(0).indexOf(t) && n.item(-1) !== e) {
                  this.__lines.splice(i + 1, 0, new u(this)),
                    (this.previous_line =
                      this.__lines[this.__lines.length - 2]);
                  break;
                }
          ...
          ((p.prototype = new n())._is_comment = function (t) {
            ...
            (p.prototype._read_pair = function (t, e) {
              ...
              return (
                (i =
                  "#" === t && "{" === e
                    ? this._create_token(f.START_BLOCK, t + e)
                ...
                "/" === t &&
                  ...
                  "*" === this._input.peek(1)
                    ? ((t = this.__patterns.block_comment.read()),
                      ...
                      ((i = this._create_token(f.BLOCK_COMMENT, t)).directives =
                        e))
                    : "/" === this._input.peek(1) &&
                      ((t = this.__patterns.comment.read()),
                      (i = this._create_token(f.COMMENT, t)))),
                i
              );
            }),
                        ...
                        if (
                          ...
                          if ((n.next(), "x" === n.peek()))
                            ...
                            u =
                              ...
                              n.match(/u\{([0-9A-Fa-f]+)\}/g);
                          }
                          if (!u) return t;
                          if (
                            126 < (i = parseInt(u[1], 16)) &&
                            i <= 255 &&
                            0 === u[0].indexOf("x")
                          )
                            return t;
          ...
          (e.prototype.restart = function () {
            ...
            (e.prototype.read = function (t, e, i) {
              var n,
                u = "";
              return (
                t && (n = this.match(t)) && (u += n[0]),
                !e || (!n && t) || (u += this.readUntil(e, i)),
                u
              );
            }),
        ...
        function (t, e, i) {
          ...
          (n.prototype.tokenize = function () {
            ...
            for (
              var t, e = new _(o.START, ""), i = null, n = [], u = new s();
              e.type !== o.EOF;

            ) {
              for (t = this._get_next_token(e, i); this._is_comment(t); )
                u.add(t), (t = this._get_next_token(e, i));
          ...
          ((u.prototype = new n()).__set_whitespace_patterns = function (t, e) {
            ...
            (u.prototype.__split = function (t, e) {
              for (var i = (t.lastIndex = 0), n = [], u = t.exec(e); u; )
                n.push(e.substring(i, u.index)),
                  (i = u.index + u[0].length),
                  (u = t.exec(e));
              return (
                i < e.length ? n.push(e.substring(i, e.length)) : n.push(""), n
              );
            }),
        ...
        function (t, e, i) {
          var n = i(12).Pattern,
            u = { django: !1, erb: !1, handlebars: !1, php: !1, smarty: !1 };
          function _(t, e) {
            n.call(this, t, e),
